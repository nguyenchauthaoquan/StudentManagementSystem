...
class PersonController extends Controller
{
    ...
    public function students() {
        return response()->json(Student::all()->jsonSerialize(), Response::HTTP_OK);
    }
    ...
    public function addStudent(Request $request) {
        ...
        return response()->json($student->jsonSerialize(), Response::HTTP_CREATED);
    }
    ...
    public function updateStudent(Request $request, $id) {
        ...
        return response()->json($student->jsonSerialize(), Response::HTTP_OK);
    }
